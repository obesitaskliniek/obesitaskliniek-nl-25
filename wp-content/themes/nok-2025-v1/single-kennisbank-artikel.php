<?php
/**
 * Single post template for Kennisbank "artikel" category
...
$layout_id = get_theme_mod('template_layout_kennisbank_artikel', 0);
...
if ($layout_id) {
    ...
    get_template_part('template-parts/single', 'kennisbank-artikel-content');
}
