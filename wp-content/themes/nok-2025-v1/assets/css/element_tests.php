...
<section class="nok25-section">
    <div class="nok25-grid__wrapper two-columns w-100" style="--grid-gap: 0;">
        ...
        <figure class="nok25-rounded-border-large-right tuck-under pull-down nok-align-self-end nok-image-natural-fit-width mh-50-vh nok25-mr-section-padding-to-lg">
