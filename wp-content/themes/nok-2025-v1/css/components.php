    ...
    nok-bg-darkerblue nok-text-white">
        <div class="nok-section__inner">
            ...
            <article class="nok-layout-grid nok-layout-grid__2-column fill-fill nok-align-items-start">
                ...
                <nok-block-group class="nok-draggable__horizontal nok-mt-2" data-requires="./modules/hnl.draggable"
                     data-snap-items="nok-square-block" data-scroll-snapping="true">
                    <div class="block_container draggable-container">
                        <?php $x = 6; while ($x--) : ?>
                            <nok-square-block class="nok-draggable-slider-item nok-bg-darkblue">
                                ...
                                <a class="nok-square-block__link" href="#">Read more
...
<nok-section>
    <div class="nok-section__inner--stretched">
        <div class="nok-section__inner">
            <article class="nok-layout-grid nok-layout-grid__2-column fill-fill nok-align-items-start nok-gap-3">
                <div class="nok-layout-flex-column nok-align-items-stretch">
                    ...
                    <nok-square-block class="nok-draggable__horizontal nok-p-2
                    nok-bg-body--darker nok-dark-bg-darkblue nok-text-contrast" data-requires="./modules/hnl.draggable"
                                      data-snap-items="nok-draggable-slider-item" data-scroll-snapping="true">
                        <div class="draggable-container">
                            <div class="nok-draggable-slider-item">
                                <blockquote class="nok-square-block__text">
                                    "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet doloribus iure perspiciatis quod, quos
                                    vero. Architecto, blanditiis est exercitationem illo iusto magni nihil nulla, quam quas, quia
                                    reprehenderit vel voluptatum. Lorem ipsum dolor sit amet, consectetur adipisicing elit!"
                                </blockquote>
                                <div class="nok-layout-flex-column nok-align-items-start no-flex-gap">
...
<nok-page-footer class="nok-section">
    ...
    nok-bg-white nok-dark-bg-darkestblue nok-text-darkblue nok-dark-text-white">
        <div class="nok-section__inner nok-page-footer__inner">
            <div class="nok-layout-grid nok-layout-grid__2-column fill-fill nok-align-items-center nok-gap-3">
