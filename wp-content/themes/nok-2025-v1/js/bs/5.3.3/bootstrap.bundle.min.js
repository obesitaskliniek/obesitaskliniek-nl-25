...
O.getOrCreateInstance(this,a);if("string"===typeof a){if("undefined"===typeof b[a])throw new TypeError(`No method named "${a}"`);b[a]()}})}static clearMenus(a){if(2!==a.button&&("keyup"!==a.type||"Tab"===a.key)){var b=p.find('[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled).show');for(const d of b){b=O.getInstance(d);if(!b||!1===b._config.autoClose)continue;var c=a.composedPath();const e=c.includes(b._menu);c.includes(b._element)||"inside"===b._config.autoClose&&!e||"outside"===b._config.autoClose&&
e||b._menu.contains(a.target)&&("keyup"===a.type&&"Tab"===a.key||/input|select|option|textarea|form/i.test(a.target.tagName))||(c={relatedTarget:b._element},"click"===a.type&&(c.clickEvent=a),b._completeHide(c))}}}static dataApiKeydownHandler(a){var b=/input|textarea/i.test(a.target.tagName),c="Escape"===a.key;const d=["ArrowUp","ArrowDown"].includes(a.key);if(d||c)if(!b||c)a.preventDefault(),b=this.matches('[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled)')?this:p.prev(this,'[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled)')[0]||
p.next(this,'[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled)')[0]||p.findOne('[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled)',a.delegateTarget.parentNode),c=O.getOrCreateInstance(b),d?(a.stopPropagation(),c.show(),c._selectMenuItem(a)):c._isShown()&&(a.stopPropagation(),c.hide(),b.focus())}}g.on(document,"keydown.bs.dropdown.data-api",'[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled)',O.dataApiKeydownHandler);g.on(document,"keydown.bs.dropdown.data-api",".dropdown-menu",
O.dataApiKeydownHandler);g.on(document,"click.bs.dropdown.data-api",O.clearMenus);g.on(document,"keyup.bs.dropdown.data-api",O.clearMenus);g.on(document,"click.bs.dropdown.data-api",'[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled)',function(a){a.preventDefault();O.getOrCreateInstance(this).toggle()});F(O);const vc={className:"modal-backdrop",clickCallback:null,isAnimated:!1,isVisible:!0,rootElement:"body"},wc={className:"string",clickCallback:"(function|null)",isAnimated:"boolean",isVisible:"boolean",
rootElement:"(element|string)"};class Ib extends pa{constructor(a){super();this._config=this._getConfig(a);this._isAppended=!1;this._element=null}static get Default(){return vc}static get DefaultType(){return wc}static get NAME(){return"backdrop"}show(a){if(this._config.isVisible){this._append();var b=this._getElement();this._config.isAnimated&&b.offsetHeight;b.classList.add("show");this._emulateAnimation(()=>{A(a)})}else A(a)}hide(a){this._config.isVisible?(this._getElement().classList.remove("show"),
this._emulateAnimation(()=>{this.dispose();A(a)})):A(a)}dispose(){this._isAppended&&(g.off(this._element,"mousedown.bs.backdrop"),this._element.remove(),this._isAppended=!1)}_getElement(){if(!this._element){const a=document.createElement("div");a.className=this._config.className;this._config.isAnimated&&a.classList.add("fade");this._element=a}return this._element}_configAfterMerge(a){a.rootElement=W(a.rootElement);return a}_append(){if(!this._isAppended){var a=this._getElement();this._config.rootElement.append(a);
g.on(a,"mousedown.bs.backdrop",()=>{A(this._config.clickCallback)});this._isAppended=!0}}_emulateAnimation(a){Bb(a,this._getElement(),this._config.isAnimated)}}const xc={autofocus:!0,trapElement:null},yc={autofocus:"boolean",trapElement:"element"};class Jb extends pa{constructor(a){super();this._config=this._getConfig(a);this._isActive=!1;this._lastTabNavDirection=null}static get Default(){return xc}static get DefaultType(){return yc}static get NAME(){return"focustrap"}activate(){this._isActive||
