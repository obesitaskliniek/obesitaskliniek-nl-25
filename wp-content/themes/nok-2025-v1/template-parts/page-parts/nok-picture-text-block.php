 ...
 * - colors:select(Blauw::nok-text-darkerblue|Transparant::nok-text-darkerblue)
...
?>
    ...
    <nok-section class="nok-text-darkerblue nok-dark-text-white
    <?= $collapse ? 'collapse-bottom pull-down' : ''; ?>"
    style="background-image: radial-gradient(circle at 75% 110%, <?=$circle_color;?> 55%, transparent 55%);">
        <div class="nok-section__inner">
            <article class=" <?= $collapse ? 'nok-mt-2' : 'nok-my-2'; ?> align-self-stretch
                        text-start
                        nok-layout-grid
                        nok-columns-8 nok-columns-to-xl-1
