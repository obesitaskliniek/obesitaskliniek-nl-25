            ...
            <nok-bmi-calculator class="nok-layout-grid nok-grid-gap-3 nok-align-items-start" data-requires="./nok-bmi-calculator.mjs?cache=<?= time(); ?>">
                <nok-square-block class="calculator-inputs nok-layout-grid nok-layout-grid__2-column half-grid-gap nok-align-items-center
                    ...
                    foreach ( $calculatorInputs as $niceName => $id ) :
                        ...
                        <input class='nok-fs-4 fw-bold' type='number' onfocus=\"this.dataset.original=this.value; this.value=''\" onblur=\"if(!this.value) this.value=this.dataset.original\" inputmode='decimal' pattern='^\d+(?:\.\d{1,2})?$' id='{$id['name']}Number' data-input-for='{$id['name']}' min='50' max='250' step='0.1' value='{$id['default']}' data-default='{$id['default']}'>
                ...
                <nok-square-block class="calculator-conclusion nok-layout nok-layout-grid half-grid-gap
                    ...
                    <div class="conclusion-text">
                        <p>
                            <span class="show-bmi-normaal">Met <span data-input-for="healthyWeightRange.current" data-value-suffix=" kg"></span> zit uw gewicht binnen de marge
                            ...
                            <span class="show-not-bmi-normaal">
                                ...
                                en <span class="fw-bold" data-input-for="healthyWeightRange.max" data-value-suffix=" kg"></span>. U bent momenteel dus ongeveer
                            ...
                            <span class="show-behandeling-nok-regulier">
                                ...
                                Wilt u meer weten? Meld u <a href="https://www.obesitaskliniek.nl/aanmelden-gratis-voorlichtingsavond/" target="_blank">hier</a> aan voor een gratis voorlichting.
                            </span>
                        </p>

                        <p class="show-behandeling-nok-clinics nok-mt-1">
                            U kunt voor behandeling óók terecht bij NOK Clinics; plan <a href="https://nokclinics.nl/intake-plannen?onderwerp_aanvraag=Ik+wil+graag+een+intake+plannen" target="_blank">hier</a> een intake op de website.
                        </p>
                    </div>

                </nok-square-block>
                <div class="conclusion-footer small nok-text-universal-contrast nok-span-all-columns">
                    <p>Let op: de berekende BMI is met deze rekenmethode niet geldig voor baby’s, zwangere vrouwen of vrouwen die borstvoeding geven, ernstig zieke personen, atleten of volwassenen van 74 jaar of ouder.</p>
                    <p>Meetgegevens op basis van de <a href="https://www.partnerschapovergewicht.nl/richtlijn-overgewicht-en-obesitas/" target="_blank">Zorgstandaard Obesitas 10-07-2023</a></p>
                </div>
            </nok-bmi-calculator>
