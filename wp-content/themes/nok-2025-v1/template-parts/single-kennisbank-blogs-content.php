<?php
/**
 * Content template for Kennisbank "blogs" category posts
...
<nok-section class="z-ascend no-aos">
    <article class="nok-section__inner nok-section-narrow nok-text-darkerblue nok-dark-text-white--darker <?= $article_class; ?>">
